...
import 'package:ecommerce/buyyNowPage.dart';
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Wrap(
                      children: <Widget>[
                        for(int i = 0; i < widget.bookModel.authors.length; i++)
                          Padding(
                            padding: EdgeInsets.all(8.0),
                            child: Chip(
                              label: Text(widget.bookModel.authors[i],style: TextStyle(
                               fontWeight: FontWeight.bold,
                                color: Colors.primaries[i
                                    %widget.bookModel.authors.length
                                ]
                              ),),
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (_,index){
                                    return ListTile(
                                        ...
                                        onTap: () {
                                          Provider.of<BookQuantity>(context,listen: false).display(index+1);
                ...
                Padding(
                  ...
                  child: Center(
                    child: InkWell(
                      onTap: (){
                        Route route = MaterialPageRoute(builder: (_)=>ComingSoon());
                ...
                Padding(
                  ...
                  child: Center(
                    child: InkWell(
                      onTap: ()=> checkItemInCart(widget.bookModel.isbn, context),
                      child: Container(
                        decoration: BoxDecoration(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 10.0),
                          child: Text(widget.bookModel.longDescription,
