...
import 'package:ecommerce/src/theme/color/light_color.dart';
...
import 'Store/Widgets/customAppBar.dart';
...
//                              authors: snapshot
//                                  .data.documents[index].data['authors'],
//                              longDescription: snapshot.data.documents[index]
//                                  .data['longDescription'],
//                              pageCount: snapshot
//                                  .data.documents[index].data['pageCount'],
//                              thumbnailUrl: snapshot
//                                  .data.documents[index].data['thumbnailUrl'],
//                              isbn:
//                              snapshot.data.documents[index].data['isbn'],
//                            ),
                      BookModel model = BookModel.fromJson(snapshot
  ...
  Widget sourceInfo(BookModel model,BuildContext context ,{Color background,removeCartFunction}) {
    return InkWell(
      onTap: (){
        Route route = MaterialPageRoute(builder: (_)=>ProductPage(bookModel: model));
              ...
              Expanded(
                ...
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child:
                    removeCartFunction==null?IconButton(
                        icon: Icon(
